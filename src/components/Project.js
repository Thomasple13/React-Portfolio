...
const IMAGE4 = 'https://imgur.com/XlM5DZu.png';
            ...
            <Stack pt={10} align={"center"}>
              <Flex>
                <Button
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    window.open("https://github.com/Lawhornmatt/Jukebox-vite");
                  }}
                >
                  <FaGithub />
                </Button>
                <Button
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    window.open("https://jukebox-project3.herokuapp.com/");
                  }}
                >
                  <FaExternalLinkAlt />
                </Button>
              ...
              <Stack direction={"row"} align={"center"}>
                <Text align={"center"}>
                  An entertaining website that lets people make rooms to share and watch videos together.
                </Text>
              </Stack>
            </Stack>
          </Box>
